...
//   x - <any>, incoming value which will be returned in callback
//   callback - <Function>, callback to be called with first argument
const asyncId = (x, callback) => {
  callback(null, x);
};

// Mapable object iteration identity function
//   items - <Array> | <Object> with map method
//   fn - <any>, Not used. Reserved for compatibility with other iterator func
//   callback - <Function>, will be called with copy of items
const mapIterationId = (items, fn, callback) => {
